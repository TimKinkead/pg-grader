...
module.exports = function(app) {
    ...
    app.route('/data/scoresheet/download')
        .get(scoresheet.download);

    // download score sheets (SRI format)
    app.route('/data/scoresheet/download/sri')
        .get(scoresheet.downloadSRI);

    // count scoresheets
    app.route('/data/scoresheet/count')
        .get(scoresheet.count);
