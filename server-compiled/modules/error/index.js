...
module.exports = function () {
    ...
    var controller = {},
        ...
        globPatterns = ['server/modules/' + moduleName + '/controller/*.js', 'server/modules/' + moduleName + '/controller/**/*.js'],
        rootPath = 'server/modules/' + moduleName;
    // glob files
    file.globber(globPatterns, rootPath).forEach(function (routePath) {
