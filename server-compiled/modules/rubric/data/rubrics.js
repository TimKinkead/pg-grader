...
// BPA
{
	...
	fields: [{
		...
		details: [{ score: 1, text: 'Includes disciplinary content in explanations, but understanding of content is weak; content is irrelevant, inappropriate, or inaccurate.' }, { score: 1.5 }, { score: 2, text: 'Briefly notes disciplinary content relevant to the prompt; shows basic or uneven understanding of content with minor errors in explanation.' }, { score: 2.5 }, { score: 3, text: 'Accurately presents disciplinary content relevant to the prompt with sufficient explanations that demonstrate understanding.' }, { score: 3.5 }, { score: 4, text: 'Integrates relevant and accurate disciplinary content with thorough explanations that demonstrate in-depth understanding.' }]
	}]
},
...
// Cold War (Red Scare)
{
	...
	fields: [{
		...
		details: [{ score: 1, text: 'Includes minimal background information relevant to the topic.' }, { score: 1.5 }, { score: 2, text: 'Makes a connection to a relevant context -- political, social or economic circumstances of the time or place, or prior historical events, ideas, or conditions.' }, { score: 2.5 }, { score: 3, text: 'Explains connections to relevant contexts -- political, social or economic circumstances of the time and place, and/or prior historical events, ideas, or conditions.' }, { score: 3.5 }, { score: 4, text: 'Clearly explains and integrates connections to relevant and significant contexts -- political, social or economic circumstances of the time and place and/or prior historical events, ideas, or conditions -- in ways that strengthen or deepen the explanation or argument.' }]
	}]
},
...
// Fracking
{
	...
	fields: [{
		...
		name: 'Organization',
		details: [{ score: 1, text: 'Lacks an evident structure. Makes unclear connections among claims, reasons, and/or evidence.' }, { score: 1.5 }, { score: 2, text: 'Groups ideas and uses transitions to develop the argument, with minor lapses in coherence or organization.' }, { score: 2.5 }, { score: 3, text: 'Groups and sequences ideas to develop the controlling idea. Uses transitions to clarify the relationships among claim(s), reasons, and evidence.' }, { score: 3.5 }, { score: 4, text: 'Groups and sequences ideas logically to develop the controlling idea and create cohesion. Uses varied transitions to clarify the relationships among claim(s),  reasons, and evidence.' }]
	}, {
		name: 'Conventions',
		details: [{ score: 1, text: 'Major errors in standard English conventions interfere with the clarity of the writing.\nLanguage or tone is inappropriate.' }, { score: 1.5 }, { score: 2, text: 'Errors in standard English conventions sometimes interfere with the clarity of the writing.\nUses language and tone that are sometimes inappropriate for the audience and purpose.' }, { score: 2.5 }, { score: 3, text: 'Consistently applies standard English conventions; minor errors, while noticeable, do not interfere with the clarity of the writing.\nUses language and tone appropriate to the audience and purpose.' }, { score: 3.5 }, { score: 4, text: 'Consistently applies standard English conventions, with few errors. Demonstrates varied syntax and precise word choice.\nConsistently uses language and tone appropriate to the audience and purpose.' }]
	}, {
...
// UN (Children's Rights)
{
	...
	fields: [{
		...
		details: [{ score: 1, text: 'Relies primarily on one source to support ideas or claims.' }, { score: 1.5 }, { score: 2, text: 'Uses multiple sources to support specific ideas or claims, without explicitly comparing or integrating sources or evidence.' }, { score: 2.5 }, { score: 3, text: 'Makes explicit connections between sources by comparing or contrasting information, perspectives, and/or origins to support specific ideas or claims.' }, { score: 3.5 }, { score: 4, text: 'Makes significant and nuanced connections between sources by comparing and contrasting information, perspectives, and/or origins to strengthen, refine, or explain limitations of specific ideas or claims.' }]
	}]
},
